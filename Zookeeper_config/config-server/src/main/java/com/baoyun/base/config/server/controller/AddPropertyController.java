	...
	public NoPageResultModel addProperty(
		...
		try {
			...
			if ((boolean) resultModel.getData()) 
				log.info("add property success, txNo: {}, groupName: {}, propertyKey: {}, propertyValue: {}, propertyDesc: {}",txNo, groupName, propertyKey, propertyValue, propertyDesc);
			 else 
				log.error("add property failed, txNo: {}, groupName: {}, propertyKey: {}, propertyValue: {}, propertyDesc: {}",txNo, groupName, propertyKey, propertyValue, propertyDesc);
			return resultModel;
		} catch (ParamInvalidException e) {
	        log.error("addProperty groupName:{} propertyKey:{} error:{} ", groupName,propertyKey,ExceptionUtils.getStackTrace(e));
