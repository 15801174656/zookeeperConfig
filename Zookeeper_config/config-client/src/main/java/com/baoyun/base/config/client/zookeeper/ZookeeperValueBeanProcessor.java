    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (bean != null) {
            ...
            if (beanFieldArray == null || beanFieldArray.length == 0) {
                log.warn(" postProcessBeforeInitialization field array is null or empty. beanName:{} bean:{} ", beanName, bean);
            } else {
            ...
            while (!supperClass.equals(Object.class)) {
                ...
                if (beanSupperFieldArray == null || beanSupperFieldArray.length == 0) {
                    log.warn(" postProcessBeforeInitialization supper class field array is null or empty. beanName:{} bean:{} ", beanName, bean);
                } else {
        ...
        try {
            ...
            if (beanField.isAnnotationPresent(ZookeeperValue.class)) {
                ...
                if (realtime) {
                    ...
                    if (!success) {
                        log.error(" postProcessAfterInitialization-error beanName:{} bean:{} realtimeBean:{} success:{} ", beanName, bean, realtimeBean,
                                success);
                    }
                    ...
                    log.info(" processorField bean:{} beanName:{} beanField:{} success:{} ", bean, beanName, beanField, operation);
